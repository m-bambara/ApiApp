...
class ApiFragment : Fragment() {
    ...
    private fun updateData(isAdd: Boolean = false) {
        ...
        val url = StringBuilder()
            ...
            //.append("?key=").append("33c8f7b9d9c7f3bd") //左のキーを直接指定しないとアプリが起動時に落ちる
            //""の付け方とかの問題ではなく、R.string.api_keyで参照できていない？？？
            // .append("?key=").append(R.string.api_key) // Apiを使うためのApiKey =>getString()で取得で回避
